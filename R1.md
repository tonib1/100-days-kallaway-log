...
**Today's Progress**: Spent time learning how GitHub works. Sort of understanding the way forking, branching, and commits work. I didn't break anything yet. I know I have to know Git if I'm ever going to work on an open source project so I need to practice so that I don't screw anything up. 

**Thoughts:** Feels good to be back at coding.

**Link to work:** No real link to work. I guess this project is visible on my GitHub account tho...

### Day 2: November 26

**Today's Progress**: Completely forgot about this project. Spent time trying to create a conference registration form in Event Espresso for VSSA's confeerence in April 2019. I need to set up a process where one payer can set up registrations for several attendees such that VSSA can capture individual information for each person but registrations can all be paid for by one person (e.g. department chairman, secretary, etc.)

**Thoughts:** Can I count figuring out this WordPress problem as coding? I'm really tired and will probably crash soon. 
